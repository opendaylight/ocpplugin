...
import org.opendaylight.ocpjava.protocol.impl.deserialization.factories.ReDirectOutputFactory;
...
public final class MessageDeserializerInitializer {
    ...
    public static void registerMessageDeserializers(DeserializerRegistry registry) {
        ...
        helper.registerDeserializer(25, null, ReDirectOutput.class, new ReDirectOutputFactory());
    }
}
