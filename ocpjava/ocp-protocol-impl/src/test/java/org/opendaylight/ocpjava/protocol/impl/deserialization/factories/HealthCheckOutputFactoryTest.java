...
public class HealthCheckOutputFactoryTest {
    ...
    public void startUp() {
        ...
        registry.init();
        healthCheckOutputFactory = registry.getDeserializer(
                new MessageCodeKey(EncodeConstants.OCP_VERSION_ID, 1, HealthCheckOutput.class));
    }

    /**
     * Testing {@link HealthCheckOutputFactory} for correct translation into POJO
     */
    @Test
    public void testWithoutElements() {
        List<Object> bb = new ArrayList<>(); 
        HealthCheckOutput builtByFactory = BufferHelper.deserialize(healthCheckOutputFactory, bb);
