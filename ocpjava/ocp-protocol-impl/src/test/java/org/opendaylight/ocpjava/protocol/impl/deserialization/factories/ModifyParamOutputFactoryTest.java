 ...
 */
public class ModifyParamOutputFactoryTest {

    private OCPDeserializer<ModifyParamOutput> modifyParamOutputFactory;
    ...
    public void startUp() {
        ...
        registry.init();
        modifyParamOutputFactory = registry.getDeserializer(
                new MessageCodeKey(EncodeConstants.OCP_VERSION_ID, 9, ModifyParamOutput.class));
    }

    /**
     * Testing {@link ModifyParamOutputFactory} for correct translation into POJO
     */
    @Test
    public void testWithoutElements() {
        List<Object> bb = new ArrayList<>(); 
        ModifyParamOutput builtByFactory = BufferHelper.deserialize(modifyParamOutputFactory, bb);
    ...
    public void testWithElements() {
        ...
        bb.add(msg);
            ...
            bb.add(new XmlElementStart("body", "", ""));
                ...
                bb.add(new XmlElementStart("modifyParamResp", "", ""));
                ...
                bb.add(new XmlElementEnd("modifyParamResp", "", ""));
        ...
        Assert.assertNotNull("Wrong elements", builtByFactory.getObj().get(0).getId());
