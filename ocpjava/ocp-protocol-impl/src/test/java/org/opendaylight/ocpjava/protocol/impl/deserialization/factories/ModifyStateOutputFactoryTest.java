 ...
 */
public class ModifyStateOutputFactoryTest {

    private OCPDeserializer<ModifyStateOutput> modifyStateOutputFactory;
    ...
    public void startUp() {
        ...
        registry.init();
        modifyStateOutputFactory = registry.getDeserializer(
                new MessageCodeKey(EncodeConstants.OCP_VERSION_ID, 18, ModifyStateOutput.class));
    }

    /**
     * Testing {@link ModifyStateOutputFactory} for correct translation into POJO
     */
    @Test
    public void testWithoutElements() {
        List<Object> bb = new ArrayList<>(); 
        ModifyStateOutput builtByFactory = BufferHelper.deserialize(modifyStateOutputFactory, bb);
    ...
    public void testWithElements() {
        ...
        bb.add(msg);
            ...
            bb.add(new XmlElementStart("body", "", ""));
                bb.add(new XmlElementStart("modifyStateResp", "", ""));
                ...
                bb.add(new XmlElementEnd("modifyStateResp", "", ""));
