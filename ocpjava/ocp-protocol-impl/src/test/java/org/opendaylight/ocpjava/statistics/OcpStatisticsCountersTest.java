...
/**
 * General tests for OcpStatisticsCounters class
 * @author madamjak
 *
 */
public class OcpStatisticsCountersTest {
    ...
    /**
     * Initialize OcpStatisticsCounters before each test, reset counters
     */
    @Before
    ...
    public void testStartStopLogReporter(){
        ...
        statCounters.startLogReport(OcpStatisticsCounters.MINIMAL_LOG_REPORT_PERIOD / 2);
        Assert.assertTrue("Wrong - logRepoter is not running", statCounters.isRunLogReport());
        Assert.assertEquals("Wrong - bad logReportPeriod", OcpStatisticsCounters.MINIMAL_LOG_REPORT_PERIOD, statCounters.getLogReportPeriod());
        statCounters.stopCounting();
        Assert.assertFalse("Wrong - logRepoter is running", statCounters.isRunLogReport());
    }
