 ...
 */
public class SetTimeOutputFactoryTest {

    private OCPDeserializer<SetTimeOutput> setTimeOutputFactory;
    ...
    public void startUp() {
        ...
        registry.init();
        setTimeOutputFactory = registry.getDeserializer(
                new MessageCodeKey(EncodeConstants.OCP_VERSION_ID, 3, SetTimeOutput.class));
    }
    ...
    public void testWithoutElements() {
        ...
        SetTimeOutput builtByFactory = BufferHelper.deserialize(setTimeOutputFactory, bb);
