 ...
 */
public class ReResetOutputFactoryTest {

    private OCPDeserializer<ReResetOutput> reResetOutputFactory;
    ...
    public void startUp() {
        ...
        registry.init();
        reResetOutputFactory = registry.getDeserializer(
                new MessageCodeKey(EncodeConstants.OCP_VERSION_ID, 5, ReResetOutput.class));
    }

    /**
     * Testing {@link ReResetOutputFactory} for correct translation into POJO
     */
    @Test
    public void testWithoutElements() {
        List<Object> bb = new ArrayList<>(); 
        ReResetOutput builtByFactory = BufferHelper.deserialize(reResetOutputFactory, bb);
